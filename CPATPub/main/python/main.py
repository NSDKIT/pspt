...
def modify_excel_k1(file_path, k1_value):
    try:
        # 一時ファイルのパスを作成
        temp_file_path = file_path.replace('.xlsm', '_temp.xlsm')
...
if __name__ == "__main__":
    ...
    NumberOfWork = 50   # 1ケースの作業回数（参考：TargetOfNumber=1->NumberOfWork15, TargetOfNumber=2->NumberOfWork100）
    ...
    excel_file_path = "C:\\Users\\PowerSystemLab\\Documents\\FromDesktop\\01_研究資料\\05_実行ファイル\\CPAT\\02_MyModel\\CPATFreeR05V1.0\\CPATFree_R05_Ver1.0\\model\\EAST10\\main\\condition0.xlsm"
    ...
    while k1_value <= k1_max:
        ...
        for mdl_file in mdl_files:
            ...
            for _ in range(NumberOfWork):
                ...
                rename_folder(os.path.join(path_to_folder, "EAST10peak_AllThermal_AllDemand_auto_copy"), os.path.join(path_to_folder, str(b3_value)))
